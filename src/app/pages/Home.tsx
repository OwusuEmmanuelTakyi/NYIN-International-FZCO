            ...
            {[
              {
                ...
                desc: "Licensed gold off-take, bullion trading, hedging strategies, and end-to-end logistics coordination across African and global markets.",
                href: "/trading",
              },
              {
                num: "02",
                ...
                desc: "Non-dilutive financing solutions backed by physical gold production, empowering miners while delivering asset-backed returns.",
                href: "/streaming",
              },
              {
                num: "03",
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mb-10 text-lg leading-relaxed max-w-2xl mx-auto" style={{ color: "var(--color-text-muted)" }}>
            Connect with our team to explore how we can support your gold trading, financing, or advisory needs.
          </p>
